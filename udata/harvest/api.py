...
job_fields = api.model(
    "HarvestJob",
    {
        ...
        "created": fields.ISODateTime(
            description="The job creation date", required=True
        ),
        ...
        "items": fields.List(
            fields.Nested(item_fields), description="The job collected items"
        ),
...
source_fields = api.model(
    "HarvestSource",
    {
        ...
        "deleted": fields.ISODateTime(
            description="The source deletion date", readonly=True
        ),
