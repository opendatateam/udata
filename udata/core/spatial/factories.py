...
class GeoJsonProvider(BaseProvider):
    ...
    def multipoint(self):
        coordinates = [
            generate_random("Point")["coordinates"] for _ in self.random_range()
        ]
    ...
    def multilinestring(self):
        coordinates = [
            generate_random("LineString")["coordinates"] for _ in self.random_range()
        ]
    ...
    def multipolygon(self):
        coordinates = [
            generate_random("Polygon")["coordinates"] for _ in self.random_range()
        ]
    ...
    def geometry_collection(self):
        ...
        return {
            ...
            "geometries": [
                self.random_element(element_factories)() for _ in self.random_range()
            ],
        }
