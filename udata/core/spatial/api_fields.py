...
zone_fields = api.model('GeoZone', {
    ...
    'parents': fields.List(fields.String, description='Every known parent zones'),
    'keys': fields.Raw(description='Some arbitry key-value identifying the zone'),
    'population': fields.Integer(description='An estimated/approximative population'),
    'area': fields.Integer(description='An estimated/approximative area'),
    'geom': fields.Nested(geojson, description='A multipolygon for the whole coverage'),
})
