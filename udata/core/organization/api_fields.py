...
org_fields = api.model('Organization', {
    ...
    'badges': fields.List(fields.Nested(badge_fields, description='The organization badges'), readonly=True),
})
...
org_suggestion_fields = api.model('OrganizationSuggestion', {
    ...
    'page': fields.UrlFor('organizations.show_redirect', lambda o: {'org': o['slug']},
        description='The organization web page URL', readonly=True),
