...
checksum_fields = api.model(
    "Checksum",
    {
        ...
        "value": fields.String(
            description="The resulting checksum/hash", required=True
        ),
    },
)
...
dataset_harvest_fields = api.model(
    "HarvestDatasetMetadata",
    {
        ...
        "created_at": fields.ISODateTime(
            description="The dataset harvested creation date",
            allow_null=True,
            readonly=True,
        ),
        "modified_at": fields.ISODateTime(
            description="The dataset harvest last modification date",
            allow_null=True,
            readonly=True,
        ),
        ...
        "last_update": fields.ISODateTime(
            description="The last harvest date", allow_null=True
        ),
        "remote_url": fields.String(
            description="The dataset remote url", allow_null=True
        ),
        ...
        "archived_at": fields.ISODateTime(
            description="The archive date", allow_null=True
        ),
...
resource_harvest_fields = api.model(
    ...
    {
        "created_at": fields.ISODateTime(
            description="The resource harvested creation date",
            allow_null=True,
            readonly=True,
        ),
        "modified_at": fields.ISODateTime(
...
resource_internal_fields = api.model(
    "ResourceInternals",
    {
        "created_at_internal": fields.ISODateTime(
            description="The resource's internal creation date on the site",
            required=True,
        ),
...
temporal_coverage_fields = api.model(
    "TemporalCoverage",
    {
        "start": fields.ISODateTime(
            description="The temporal coverage start date", required=True
        ),
...
dataset_ref_fields = api.inherit(
    ...
    base_reference,
    {
        ...
        "acronym": fields.String(
            description="An optional dataset acronym", readonly=True
        ),
        "uri": fields.UrlFor(
            "api.dataset",
            lambda d: {"dataset": d},
...
dataset_internal_fields = api.model(
    ...
    {
        "created_at_internal": fields.ISODateTime(
            description="The dataset's internal creation date on the site",
            required=True,
        ),
        "last_modified_internal": fields.ISODateTime(
...
dataset_fields = api.model(
    "Dataset",
    {
        ...
        "contact_point": fields.Nested(
            ...
            allow_null=True,
            description="The dataset's contact points",
        ),
    },
    mask=DEFAULT_MASK,
)
...
catalog_schema_fields = api.model(
    "CatalogSchema",
    {
        ...
        "schema_type": fields.String(
            enum=["tableschema", "datapackage", "jsonschema", "other"]
        ),
