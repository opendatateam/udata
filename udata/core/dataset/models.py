...
class ResourceMixin(object):
    ...
    created_at_internal = db.DateTimeField(default=lambda: datetime.now(UTC), required=True)
    last_modified_internal = db.DateTimeField(default=lambda: datetime.now(UTC), required=True)
