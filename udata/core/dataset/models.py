...
from udata.utils import get_by, hash_url, date_or_aware_datetime_to_naive_datetime
        ...
        if self.resources:
            ...
            for res in self.resources:
                ...
                if res.harvest and res.harvest.modified_at:
                    dates.append(date_or_aware_datetime_to_naive_datetime(res.harvest.modified_at))
            return max(dates)
        else:
