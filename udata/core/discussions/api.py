...
discussion_fields = api.model(
    "Discussion",
    {
        ...
        "subject": fields.Nested(
            api.model_reference, description="The discussion target object"
        ),
...
start_discussion_fields = api.model(
    ...
    {
        "title": fields.String(
            description="The title of the discussion to open", required=True
        ),
        "comment": fields.String(
            description="The content of the initial comment", required=True
        ),
        "subject": fields.Nested(
            api.model_reference,
...
class DiscussionAPI(API):
    ...
    @api.response(
        403,
        "Not allowed to close this discussion "
