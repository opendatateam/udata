...
topic_fields = api.model('Topic', {
    ...
    'description': fields.Markdown(description='The topic description in Markdown', required=True),
    ...
    'uri': fields.UrlFor('api.topic', lambda o: {'topic': o},
        description='The topic API URI', readonly=True),
    'page': fields.UrlFor('topics.display', lambda o: {'topic': o},
...
class TopicsAPI(API):
    ...
    def get(self):
        ...
        return Topic.objects.order_by('-created').paginate(args['page'], args['page_size'])
