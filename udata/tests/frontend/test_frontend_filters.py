...
class FrontEndRootTest(FrontTestCase):
    ...
    def test_daterange(self):
        ...
        specs = (
            (dr('2014-02-01', '2014-02-01'), '2014'),
            (dr('2012-01-01', '2012-01-31'), '2012'),
            (dr('2012-01-01', '2012-01-14'), '2012'),
            (dr('2012-01-01', '2012-03-31'), '2012'),
            (dr('2012-01-01', '2012-02-29'), '2012'),
            (dr('2012-01-01', '2012-12-31'), '2012'),
            (dr('2012-01-01', '2014-12-31'), '2012–2014'),
            (dr('2012-02-02', '2014-12-25'), '2012–2014'),
        )
    ...
    def test_daterange_before_1900(self):
        ...
        specs = (
            (dr('1234-02-01', '1234-02-01'), '1234'),
            (dr('1232-01-01', '1232-01-31'), '1232'),
            (dr('1232-01-01', '1232-01-14'), '1232'),
            (dr('1232-01-01', '1232-03-31'), '1232'),
            (dr('1232-01-01', '1232-02-29'), '1232'),
            (dr('1232-01-01', '1232-12-31'), '1232'),
            (dr('1232-01-01', '1234-12-31'), '1232–1234'),
            (dr('1232-02-02', '1234-12-25'), '1232–1234'),
        )
        for given, expected in specs:
            self.assertEqual(
                render_template_string('{{given|daterange}}', given=given),
