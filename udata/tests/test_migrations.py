...
def mock(app, tmpdir, mocker):
    ...
    mocker.patch(
        "udata.migrations.resource_listdir", side_effect=m.mock_resource_listdir
    )
    ...
    mocker.patch(
        "udata.migrations.resource_filename", side_effect=m.mock_resource_filename
    )
    mocker.patch(
        "udata.entrypoints.get_enabled", side_effect=m.mock_get_enabled_entrypoints
    )
    mocker.patch(
        "udata.entrypoints.get_plugin_module", side_effect=m.mock_get_plugin_module
    )
    yield m
