...
class UserAPITest(APITestCase):
    ...
    def test_suggest_users_api_first_name(self):
        ...
        response = self.get(
            url_for("api.suggest_users"), qs={"q": "first-name-test", "size": "5"}
        )
        self.assert200(response)
    ...
    def test_suggest_users_api_last_name(self):
        ...
        response = self.get(
            url_for("api.suggest_users"), qs={"q": "last-name-test", "size": "5"}
        )
        self.assert200(response)
    ...
    def test_suggest_users_api_unicode(self):
        ...
        response = self.get(
            url_for("api.suggest_users"), qs={"q": "last-name-testé", "size": "5"}
        )
        self.assert200(response)
    ...
    def test_suggest_users_api_no_match(self):
        ...
        response = self.get(
            url_for("api.suggest_users"), qs={"q": "xxxxxx", "size": "5"}
        )
        self.assert200(response)
    ...
    def test_suggest_users_api_no_dedup(self):
        ...
        response = self.get(
            url_for("api.suggest_users"), qs={"q": "homonym", "size": "5"}
        )
        self.assert200(response)
    ...
    def test_users_as_admin(self):
        ...
        self.assertEqual(
            users[1]["email"], "thibaud@example.org"
