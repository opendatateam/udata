...
from udata.core.metrics import Metric, SiteMetric, init_app as init_metrics
...
class MetricsAPITest(APITestCase):
    ...
    def test_get_metrics_for_day(self):
        ...
        Metrics.objects.update_daily('site', yesterday, metric1='value1', metric2='value2')

        response = self.get(url_for('api.metrics_period', id='site', period=yesterday))
