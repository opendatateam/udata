...
class MembershipAPITest:
    ...
    def test_accept_membership(self, api):
        ...
        api_url = url_for(
            "api.accept_membership", org=organization, id=membership_request.id
        )
    ...
    def test_accept_membership_404(self, api):
        ...
        api_url = url_for(
            "api.accept_membership", org=organization, id=MembershipRequest().id
        )
        response = api.post(api_url)
        assert404(response)
    ...
    def test_refuse_membership(self, api):
        ...
        api_url = url_for(
            "api.refuse_membership", org=organization, id=membership_request.id
        )
    ...
    def test_refuse_membership_404(self, api):
        ...
        api_url = url_for(
            "api.refuse_membership", org=organization, id=MembershipRequest().id
        )
        response = api.post(api_url)
        assert404(response)
    ...
    def test_suggest_organizations_api(self, api):
        ...
        max_follower_organization = OrganizationFactory(
            name="test-4", metrics={"followers": 10}
        )
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "tes", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_with_special_chars(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "testé", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_with_multiple_words(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "mon testé", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_with_apostrophe(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "Ministère", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_api_no_match(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "xxxxxx", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_homonyms(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "homonym", "size": "5"}
        )
        assert200(response)
    ...
    def test_suggest_organizations_acronym(self, api):
        ...
        response = api.get(
            url_for("api.suggest_organizations"), qs={"q": "uDaTa", "size": "5"}
        )
        assert200(response)
...
class OrganizationBadgeAPITest:
    ...
    def test_delete(self, api):
        ...
        url = url_for(
            "api.organization_badge", org=self.organization, badge_kind=str(badge.kind)
        )
