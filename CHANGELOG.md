...
- Geozone's and Resource type's labelize function return None if no object is found and bleach is now used to sanitize faceted search [#2611](https://github.com/opendatateam/udata/pull/2611)
