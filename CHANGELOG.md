...
- _major_ Use pip-tools for requirements management [#2642](Use pip-tools for requirements management). Please [read the doc](https://github.com/opendatateam/udata/blob/master/docs/development-environment.md#python-and-virtual-environment) if you are a udata developer.
